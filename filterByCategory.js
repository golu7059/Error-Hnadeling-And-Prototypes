// 10 . Write a function that takes an array of products and returns a function that filters the array by a given product
...
function filterProductsByCategory(products) {
  ...
  // const booksProducts = filterByCategory("Books");
